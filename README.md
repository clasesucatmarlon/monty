...
### 15. stack, queue
-   SimpleImplement the stack and queue opcodes.
-   The stack opcode
-   The opcode stack sets the format of the data to a stack (LIFO). This is the default behavior of the program.

### 16. Holberton
-   ImplementWrite a Brainf*ck script that prints Holberton, followed by a new line.

### 17. Add two digits
-   TheAdd two digits given by the user.
-   TheRead the two digits from stdin, add them, and print the result
-   The total of the two digits with be one digit-long (<10)

## Autors

-   ***Marlon Aurelio García Morales - <https://github.com/clasesucatmarlon>***  <img src="https://avatars1.githubusercontent.com/u/60376045?s=400&u=e0a843e701d1d571676809481bd966ec74f5660c&v" alt="alt text" width="40" height="30">
